...
declare class AnimationCanvas extends BaseCanvas {
    ...
    calculateDragMinMaxValues(minSize: any, maxSize: any, defaultCord: any, grazeSize: any, tileSize: any, sideSize: any): {
        min: any;
        max: number;
    };
...
declare class BubleImageElement extends AnimationImageElement {
    constructor(ctx: any, x: any, y: any, imageCanvas: any, horiAcc: any, horiChangeChance: any, maxHori: any, vertSpeed: any, vertGoal: any, vertGoalCallback: any, vertOpacityTrigger: any, opacityDropRate: any);
    horiAcc: any;
    maxHori: any;
    vertSpeed: any;
    vertGoal: any;
...
declare class RandomBubleImageElement extends BubleImageElement {
    constructor(ctx: any, x: any, y: any, imageCanvas: any, horiAccMin: any, hoiiAccMax: any, horiChangeChanceMin: any, horiChangeChanceMax: any, maxHoriMin: any, maxHoriMax: any, vertSpeedMin: any, vertSpeedmax: any, vertGoal: any, vertGoalCallback: any, vertOpacityTrigger: any, opacityDropRate: any);
}
...
declare class StaticGlowOrb extends AnimationElement {
    constructor(ctx: any, x: any, y: any, radius: any, glowRangePercent: any, glowFadeStartPercent: any, glowFadeEndPercent: any, rgbColor: any);
    baseRadius: any;
...
declare class RotatingCircleSlice extends AnimationElement {
    constructor(ctx: any, x: any, y: any, startAngel: any, containerRadius: any, radiusPercent: any, angle: any, speed: any, rgbColor: any);
    currentAngle: any;
    angle: any;
    speed: any;
    bonusSpeed: number;
...
declare class AnimationParticle extends StaticGlowOrb {
    constructor(ctx: any, x: any, y: any, radius: any, glowRangePercent: any, glowFadeStartPercent: any, glowFadeEndPercent: any, rgbColor: any, speed: any, targetShape: any);
    speed: any;
    bonusSpeed: number;
    _targetBonusSpeed: number;
    oldBonusSpeed: number;
...
declare class AnimationRandomParticle extends AnimationParticle {
    constructor(ctx: any, glowRangePercent: any, glowFadeStartPercent: any, glowFadeEndPercent: any, rgbColor: any, targetShape: any, spawnShape: any, minSpeed: any, maxSpeed: any, minRadius: any, maxRadius: any);
    spawnShape: any;
    minSpeed: any;
    maxSpeed: any;
    minRadius: any;
...
declare class AnimationShapeCircle {
    ...
    generateShortestDirection(sourceX: any, sourceY: any): {
        normVector: {
            x: number;
            y: number;
        };
...
declare class SpineAnimation {
    constructor($container: any, jsonUrl: any, atlasUrl: any, lazyLoadInfo: any, onloadCallback: any, optionActive: any, startPoseId: any, delayPoseChange: any);
    $container: any;
    $canvas: any;
    jsonUrl: any;
    atlasUrl: any;
...
declare class SpineApp {
    constructor(jsonSrc: any, atlasSrc: any, startAnimation: any, baseHeight: any, scaleXPos?: number, scaleYPos?: number, scaleZoom?: number);
    skeleton: any;
    animationState: any;
    canvas: any;
    pma: boolean;
    ...
    loadSkeleton(jsonSrc: any, atlasSrc: any, animationName: any, animationLoop?: boolean, animationQueue?: any[]): void;
...
declare class SpriteAnimation {
    constructor(canvas: any, spriteName: any, flipSprite?: boolean, scale?: number, randomOffset?: boolean, speed?: number, loop?: boolean);
    canvas: any;
    speed: number;
    flipSprite: boolean;
    loop: boolean;
...
declare class AvatarDrive {
    ...
    setup(top5Nominations: any, top5AllTime: any, top5Monthly: any, top5Weekly: any, recentDonations: any, total: any, gotFreeDonation: any): void;
...
declare class CheatTestSongEntry {
    constructor({ songId, videoLink, songName, artist, animeNames, note, correct }: {
        songId: any;
        videoLink: any;
        songName: any;
        artist: any;
...
declare class EmojiSelectorMenu {
    constructor($container: any, $button: any, $inputContainer: any, selectionCallback: any);
    $mainContainer: any;
    $container: any;
    $button: any;
    $inputContainer: any;
...
declare class EmojiSelectorGameMenu extends EmojiSelectorMenu {
    constructor($container: any, $button: any, $input: any, selectionCallback: any, $lockInContainer: any);
    $lockInContainer: any;
    setLockInMode(on: any): void;
    lockInEmoteInMsg(msg: any): void;
...
declare class EmojiSelectorEntry {
    constructor(name: any, src: any, srcSet: any, locked: any, $container: any, emoteId: any, emojiId: any, shortCode: any, callback: any);
    name: any;
    emoteId: any;
    emojiId: any;
    shortCode: any;
...
declare class ExpandQuestionBox {
    ...
    showSong(animeId: any, animeName: any, songName: any, songArtist: any, songTypeName: any, songUploadStatus: any, videoExamples: any): void;
    videoExamples: any;
...
declare class BattleRoyal {
    ...
    setupGame(players: any, isSpectator: any, settings: any, timeLeft: any, mapState: any, soloMode: any, playerBRState: any): void;
    soloMode: any;
    isSpectator: any;
    settings: any;
    players: {} | undefined;
...
declare function BattleRoyalShowEntry(annId: any, name: any, x: any, y: any, inventoryFull: any, inventoryFullMessageController: any, updatePosition: any): void;
declare class BattleRoyalShowEntry {
    constructor(annId: any, name: any, x: any, y: any, inventoryFull: any, inventoryFullMessageController: any, updatePosition: any);
    $html: JQuery<HTMLElement>;
    annId: any;
    x: number;
    y: number;
...
declare function BattleRoyalContainerEntry(x: any, y: any, $container: any, inventoryFull: any, inventoryFullMessageController: any, updatePosition: any): void;
declare class BattleRoyalContainerEntry {
    constructor(x: any, y: any, $container: any, inventoryFull: any, inventoryFullMessageController: any, updatePosition: any);
    $html: JQuery<HTMLElement>;
...
declare function BattleRoyalTileGate(gateSize: any, pointPixelSize: any, position: any, tileSize: any, updatePosition: any, isSpectator: any): void;
...
declare function BattleRoyalPlayer(name: any, avatar: any, x: any, y: any, pointPixelSize: any, self: any, tileSize: any): void;
...
declare class BattleRoyalePlayer extends GamePlayer {
    constructor(name: any, level: any, gamePlayerId: any, host: any, avatarInfo: any, positionSlot: any, teamPlayer: any, teamNumber: any);
    inGame: boolean;
    positionSlot: any;
    teamPlayer: any;
    teamNumber: any;
...
declare class GameChat {
    ...
    chatMessage({ sender, modMessage, message, emojis, badges, messageId, atEveryone, teamMessage, nameColor, nameGlow, }: {
        sender: any;
        modMessage: any;
        message: any;
        emojis: any;
...
declare class LobbyAvatarSlot {
    constructor(avatarInfo: any, playerName: any, playerLevel: any, isReady: any, isHost: any, isSelf: any, teamNumber: any, numberOfTeams: any, teamFullMap: any, mixedAnswerMode: any, multipleChoice: any);
...
declare class LobbyPlayer extends GamePlayer {
    constructor(name: any, level: any, gamePlayerId: any, host: any, avatarInfo: any, ready: any, teamNumber: any, numberOfTeams: any, teamFullMap: any, mixedAnswerMode: any, multipleChoice: any);
    _ready: any;
...
declare class LobbyRuleModalEntrySet {
    constructor(name: any, $entries: any, maxSizeMap: any, customOffsetMap: any, mainController: any, nameMap: any, onFinishCallback: any);
    name: any;
...
declare class SettingMessageFormater {
    ...
    translateVintageSeason(seasonId: any): "Winter" | "Spring" | "Summer" | "Fall" | undefined;
    translateVintageEntry(entry: any): string;
    formatGenreTagString(entry: any, name: any): string | undefined;
    translateSettingNameToText(setting: any): "Vintage" | "Anime Score" | "Player Score" | "Sample Point" | "Guess Time" | "Inventory Size" | "Looting Time" | "Song Selection" | "Show Selection" | "Number of Songs" | "Number of Players" | "Song Popularity" | "Song Difficulty" | "Song Types" | "Opening Categories" | "Ending Categories" | "Insert Categories" | "Room Name" | "Room Private" | "Password" | "Playback Speed" | "Game Mode" | "Modifiers" | "Type" | "Genre" | "Tags" | "Lives" | "Scoring" | "Team Size" | "Watched Distribution" | "Answering" | "Extra Guess Time" | undefined;
...
declare class AvatarAnswerStatus {
    ...
    convertStatusToClass(status: any): "" | "watching" | "completed" | "hold" | "dropped" | "planning" | "looted";
}
...
declare class FlaggedMessageContainerEntry {
    constructor({ sender, message, messageId, emojis }: {
        sender: any;
        message: any;
        messageId: any;
        emojis: any;
    }, rankedChatBanState: any, rankedChatBanTime: any, controller: any);
    $html: JQuery<HTMLElement>;
...
declare class MoeVideoPlayer extends VideoPlayer {
    ...
    loadVideo(id: any, playLength: any, startPoint: any, firstVideo: any, videoMap: any, playOnReady: any, startTime: any, playbackRate: any, videoVolumeMap: any, fullSongRange: any): void;
    videoMap: any;
    videoVolumeMap: any;
    playbackRate: any;
    ...
    resolutionOrder: any;
    songId: any;
    loadAndPlayVideo(id: any, playLength: any, startPoint: any, firstVideo: any, startTime: any, videoMap: any, playbackRate: any, videoVolumeMap: any, fullSongRange: any): void;
    getVideoVolume(): any;
    isPlaying(): boolean;
...
declare class Quiz {
    ...
    setupQuiz(players: any, isSpectator: any, quizState: any, settings: any, isHost: any, groupSlotMap: any, soloMode: any, teamAnswers: any, selfAnswer: any, champGame: any, multipleChoice: any, quizDescription: any, enemies: any, avatarAssets: any): void;
    gameMode: any;
    ownGamePlayerId: any;
...
declare class QuizAbilityIcon {
    constructor($iconContainer: any, { name, description, fileName, enabled, cooldownLength, currentCooldown, targetInfo }: {
        name: any;
        description: any;
        fileName: any;
        enabled: any;
...
declare class QuizAvatarSlotBase {
    constructor(template: any, name: any, level: any, points: any, avatarDisabled: any, poseIdMap: any, flipDamageSprite: any, poseId: any);
    $body: JQuery<HTMLElement>;
    ...
    hide(): void;
    show(): void;
    displayDamage(newHp: any, newShield: any, hpChangeText: any, maxHealth: any, damageClasses: any, attackEffectSet: any, finishedCallback: any): void;
    triggerHealthUpdate(newHp: any, newShield: any, hpChangeText: any, maxHealth: any, damageClasses: any): void;
    displayAttackEffectSetInternal(attackEffectSet: any, loop: any, scale: any): void;
    ...
    displayOverlay(src: any, srcset: any, scale: any, fadeIn: any, noShadow: any): void;
    clearOverlay(fadeOut: any): void;
    displayFlashIcon(iconSrc: any, iconSrcset: any, callback: any, $targetImage: any): void;
    getEffectClassFromHitEffectId(hitEffectId: any): "qpAvatarDamagePushOneWay" | "qpAvatarDamageShake" | "qpAvatarDamagePush";
...
declare class QuizAvatarSlot extends QuizAvatarSlotBase {
    constructor(name: any, level: any, points: any, avatarInfo: any, isHost: any, avatarDisabled: any, lifeCountEnabled: any, maxLives: any, teamPlayer: any, hidden: any, nexusSlot: any, multiChoiceActive: any, poseId: any);
...
declare class QuizEnemy extends QuizCharacter {
    ...
    updatePose(): void;
    addTargetIcon(icon: any): void;
    displayDamage(newHp: any, newShield: any, damage: any, damageClasses: any, attackEffectSet: any, finishedCallback: any, displayZero: any): void;
    ...
    displayOverlay(src: any, srcet: any, scale: any, fadeIn: any, noShadow: any): void;
    clearOverlay(fadeOut: any): void;
}
...
declare class QuizInfoContainer {
    ...
    showInfo(animeNames: any, songName: any, artist: any, type: any, typeNumber: any, urls: any, siteIds: any, animeScore: any, animeType: any, vintage: any, animeDifficulty: any, animeTags: any, animeGenre: any, altAnimeNames: any, altAnimeNamesAnswers: any): void;
    displayAnimeName(name: any, altNames?: any[], altAnswers?: any[]): void;
    displayInfoBoxHint({ artist, songName, type, typeNumber, animeScore, animeType, vintage, animeDifficulty, }: {
        artist: any;
        songName: any;
        type: any;
        typeNumber: any;
...
declare class QuizPlayer extends QuizCharacter {
    constructor(name: any, level: any, gamePlayerId: any, host: any, avatarInfo: any, points: any, avatarDisabled: any, lifeCountEnabled: any, maxLives: any, startPositionSlot: any, teamPlayer: any, teamNumber: any, hidden: any, slot: any, maxHp: any, currentHp: any, shield: any, abilityInfo: any, buffs: any, genreInfo: any, playerName: any, multiChoiceActive: any, poseId: any);
    _name: any;
    level: any;
    gamePlayerId: any;
    _host: any;
...
declare class QuizVideoController {
    ...
    nextVideoInfo(songInfo: any, playLength: any, startPoint: any, firstVideo: any, startTime: any, playbackSpeed: any, fullSongRange: any): void;
    _nextVideoInfo: {
        songInfo: any;
        playLength: any;
        startPoint: any;
...
declare class ScoreBoardEntry {
    constructor(name: any, score: any, standing: any, guessCount: any, scoreTitle: any, scoreBoardPosition: any, active: any, teamNumber: any, hidden: any, listNumber: any);
    $entry: JQuery<HTMLElement>;
    isSelf: boolean;
    positionSlot: any;
    currentPosition: any;
...
declare class GamePlayer {
    constructor(name: any, level: any, gamePlayerId: any, host: any, avatarInfo: any);
    _name: any;
    level: any;
    gamePlayerId: any;
    _host: any;
...
declare function AdvancedSettingController($switch: any, $standardSettingContainer: any, $advacnedSettingContainer: any, doubleActive: any): void;
declare class AdvancedSettingController {
    constructor($switch: any, $standardSettingContainer: any, $advacnedSettingContainer: any, doubleActive: any);
    $standardContainer: any;
    $advancedContainer: any;
    doubleActive: any;
    setOn(on: any): void;
}
declare function DropDownSettingFilter($container: any, $input: any, inputList: any): void;
...
declare class HostModal {
    ...
    show(): void;
    setup(genreInfo: any, tagInfo: any, savedSettings: any, latestQuizSettingStrings: any): void;
    ...
    getSettings(onlyValidateStaticSettings: any): false | {
...
declare class SettingRandomizer {
    ...
    randomTagGenreFilters(list: any, onlyExclude: any): {
        id: any;
        state: number;
    }[];
...
declare module "pages/gamePage/gameSettings/settingSerilizer" {
    ...
    class SettingSerilizer {
        ...
        encode(settings: any, defaultSettings?: {
            roomName: string;
            privateRoom: boolean;
            password: string;
            roomSize: number;
        ...
        decodeObject(encodedStringContainer: any, schema: any, base: any, arrayDelimiter: any, versionNumber: any): {
            insertCategories: {
                instrumental: boolean;
                chanting: boolean;
                character: boolean;
...
declare class TutorialMessageContainer {
    ...
    hide(): void;
    show(): void;
    displayState({ title, message, nextStateGroupName, nextStateNumber, options, $altTrigger, triggerEvents, hideTrigger, customTriggerSetup, clearTrigger, }: {
        title: any;
        message: any;
...
declare class TutorialState {
    constructor(tutorialController: any, title: any, message: any, nextStateGroupName: any, nextStateNumber: any, options: any, popoutElements: any, highlightElements: any, enableSoloElements: any, enableElements: any, disableElements: any, $altTrigger: any, triggerEvents: any, onClear: any, onDisplay: any, hideTrigger: any, altTargetInfo: any, onDisplayConfig: any, customTriggerSetup: any, input: any, clearTrigger: any);
    title: any;
    message: any;
...
declare function createFriendRequestHandler(accept: any, callback: any): () => void;
...
declare class SocialTabFriendEntry {
    ...
    open: boolean;
    avatarIconDisplayHandler: AvatarHeadDisplayHandler;
    get colorStatusClass(): "socialTabPlayerSocialStatusInnerCircleColorOnline" | "socialTabPlayerSocialStatusInnerCircleColorDoNotDisturb" | "socialTabPlayerSocialStatusInnerCircleColorAway" | "socialTabPlayerSocialStatusInnerCircleColorOffline";
...
declare class NexusBadge {
    constructor(level: any, { avatarId, characterId, colorId }: {
        avatarId: any;
        characterId: any;
        colorId: any;
    }, size: any, extraClasses?: any[]);
    $body: JQuery<HTMLElement>;
...
declare class NexusBadgeEmpty extends NexusBadge {
    constructor(size: any, extraClasses: any[] | undefined, popoverMessage: any, popoverContainerId: any);
    detatch(): void;
}
...
declare class NexusCityStaticElement {
    constructor(ctx: any, image: any, baseX: any, baseY: any, canvasWidth: any, collisionBoxInfo: any, nameInfo: any, clickHandler: any);
...
declare class NexusDungeonSelectionTab extends NexusCityWindowTab {
    ...
    show(): void;
    updateState(nexusStandardSoloGotState: any, nexusEndlessSoloGotState: any): void;
    DUNGEON_TYPE_IDS: {
        STANDARD: number;
        ENDLESS: number;
    };
...
declare class NexusCityDungeonSelectionWindow extends NexusCityWindow {
    ...
    setupDungeonInfo({ lobbyId, slotsInfo, avatarInfoList, teams, players, hostName, settings, badges, typeId }: {
        lobbyId: any;
        slotsInfo: any;
        avatarInfoList: any;
        teams: any;
...
declare class NexusCityDungeonSetupTab extends NexusCityWindowTab {
    ...
    updateSettings({ settings: { songTypes, difficulties, songSelection, answering }, floor }: {
        settings: {
            songTypes: any;
            difficulties: any;
            songSelection: any;
    ...
    avatarChange(clearTileSlots: any, newAvatarSlots: any): {
...
declare class NexusCityDungeonSetupTabAvatarSlot {
    ...
    displayAvatar({ avatarId, colorId, backgroundAvatarId, backgroundColorId, level, baseStats, runeInfo, genreInfo, abilityInfo, soloProgress, coopProgress, optionActive, }: {
        avatarId: any;
        colorId: any;
...
declare class NexusCityDungeonSetupTabAvatarPlayerSlot {
    ...
    hide(): void;
    show(): void;
    displayPlayer({ name, icon: { emoteId, avatarInfo: { avatar: { avatarName, outfitName, colorName, optionName, optionActive, animated }, }, }, }: {
        name: any;
        icon: {
            emoteId: any;
            avatarInfo: {
...
declare class NexusCityDungeonSetupTabConfigButton {
    constructor({ $element, defaultSelected }: {
        $element: any;
        defaultSelected: any;
    }, updateRatingCallback: any, clickCallback: any, onlySelect: any);
    $element: any;
    defaultSelected: any;
...
declare class NexusCityInnWindow extends NexusCityWindow {
    ...
    updateSelectedSkin(colorId: any, src: any, srcSet: any, backgroundSrc: any, sizeModifier: any, animated: any, jsonSrc: any, atlasSrc: any): void;
...
declare class NexusCityInnAvatarSetupTab extends NexusCityWindowTab {
    ...
    displayAvatar({ avatarId, characterId, backgroundAvatarId, backgroundColorId, colorId, sizeModifier, jsonSrc, atlasSrc, animated, src, srcSet, backgroundSrc, optionName, optionActive, }: {
        avatarId: any;
        characterId: any;
        backgroundAvatarId: any;
        backgroundColorId: any;
    ...
    toggleOption(): void;
    loadAvatar(src: any, srcSet: any, sizeModifier: any, animated: any, jsonSrc: any, atlasSrc: any): void;
    loadBackground(backgroundSrc: any): void;
    updateAvatar(colorId: any, src: any, srcSet: any, backgroundSrc: any, sizeModifier: any, animated: any, jsonSrc: any, atlasSrc: any): void;
...
declare class NexusCitySkinSelectEntry {
    constructor({ avatarId, colorId, name, sizeModifier, src, srcSet, jsonSrc, atlasSrc, backgroundSrc, unlocked, animated, }: {
        avatarId: any;
        colorId: any;
        name: any;
        sizeModifier: any;
...
declare class NexusCityInnBackgroundEntry {
    constructor({ colorId, avatarId, backgroundVert, name, unlocked }: {
        colorId: any;
        avatarId: any;
        backgroundVert: any;
        name: any;
        unlocked: any;
    }, $scrollContainer: any, window: any);
    $body: JQuery<HTMLElement>;
...
declare class NexusCityInnTeamSetupTab extends NexusCityTeamSetupTab {
    ...
    avatarSelectedForTeam(teamId: any, slotId: any, { avatarId, colorId, backgroundAvatarId, backgroundColorId, optionActive }: {
        avatarId: any;
        colorId: any;
        backgroundAvatarId: any;
        backgroundColorId: any;
...
declare class NexusCityAvatarInfoDisplay {
    ...
    handleDisplayed(): void;
    reset(): void;
    displayAvatar({ avatarId, src, srcSet, backgroundSrc, name, level, sizeModifier, baseStats, runeInfo, genreInfo, animated, jsonSrc, atlasSrc, optionActive }: {
        avatarId: any;
        src: any;
        srcSet: any;
        backgroundSrc: any;
    ...
    loadAvatar({ src, srcSet, backgroundSrc, sizeModifier, animated, jsonSrc, atlasSrc, optionActive }: {
        src: any;
        srcSet: any;
        backgroundSrc: any;
        sizeModifier: any;
...
declare class NexusCityAvatarSelector extends NexusCityWindowTab {
    constructor(window: any, $leftContainer: any, $rightContainer: any, $tab: any, selectorPreview: any, avatarEntryClass: any, clickHandler: any, extraOrderFilterInfo?: any[], clearPreviewOnHide?: boolean, clearClickHandler?: () => void);
    ...
    updateDefaultAvatarSkin(avatarId: any, colorId: any, backgroundAvatarId: any, backgroundColorId: any, optionActive: any): void;
    setSelectionCallback(callback: any): void;
}
declare class NexusCityAvatarEntry {
    constructor({ avatarInfo: { avatarId, colorId, backgroundAvatarId, backgroundColorId, optionActive, level, abilityInfo, genreInfo }, baseStats, runes, locked, earlyAccess, earlyAccessEndDate, }: {
        avatarInfo: {
            avatarId: any;
            colorId: any;
            backgroundAvatarId: any;
    ...
    }, $container: any, hoverCallback: any, clickCallback: any);
    $body: JQuery<HTMLElement>;
...
declare class NexusCityBadgeSelector extends NexusCityWindowTab {
    constructor(window: any, $leftContainer: any, $rightContainer: any, $tab: any, clickHandler: any, clearClickHandler?: () => void);
...
declare class NexusCityFilter {
    constructor(filterEntries: any, defaultSortFunction: any, $nameSearch: any, callbackFunction: any, initialSortFunction: any, toggleFilter: any);
    filterEntries: any;
...
declare class NexusCityTeamSetupTab extends NexusCityWindowTab {
    constructor(window: any, $leftContainer: any, $rightContainer: any, $tab: any, $teamContainer: any, teamRowClass: any, avatarInfoDisplay: any);
    $teamContainer: any;
    teamRowClass: any;
...
declare class NexusCityTeamRow {
    constructor({ teamId, name, avatars, badges }: {
        teamId: any;
        name: any;
        avatars: any;
        badges: any;
    }, window: any, tab: any, $container: any, teamNumber: any);
    $body: JQuery<HTMLElement>;
    teamId: any;
    name: any;
    $container: any;
...
declare class NexusCityWorkshopRuneSelectorRune {
    constructor({ description: { runeId, level, name, fileName, type, category, description, boostPercent, statPropName, customBoostName, }, amount, inUseCount, equipedAvatarIds, }: {
        description: {
            runeId: any;
            level: any;
            name: any;
...
declare class NexusCityWorkshopRuneSelectorSlotHandler {
    ...
    get allOffensiveContainers(): (NexusCityWorkshopRuneSelectorStandardContainer | NexusCityWorkshopRuneSelectorAdvancedContainer)[];
    get allDefensiveContainers(): (NexusCityWorkshopRuneSelectorStandardContainer | NexusCityWorkshopRuneSelectorAdvancedContainer)[];
    get allContainers(): (NexusCityWorkshopRuneSelectorStandardContainer | NexusCityWorkshopRuneSelectorAdvancedContainer)[];
    get allRunes(): any[];
...
declare class NexusCoopPlayerRow {
    ...
    disableHostOptions(): void;
    displayIcon({ emoteId, avatarInfo: { avatar: { avatarName, outfitName, colorName, optionName, optionActive, animated }, }, }: {
        emoteId: any;
        avatarInfo: {
            avatar: {
                avatarName: any;
...
declare class NexusDungeonResultWindowXpEntry {
    constructor({ name, entryCount, xpCount }: {
        name: any;
        entryCount: any;
        xpCount: any;
    }, speedMs: any);
...
declare class NexusDungeonResultWindowAvatarEntry {
    constructor({ avatarName, outfitName, optionName, optionActive, colorName, sizeModifier, animated }: {
        avatarName: any;
        outfitName: any;
        optionName: any;
        optionActive: any;
        ...
        sizeModifier: any;
        animated: any;
    }, backgroundVert: any, { originalXpState, newXpState }: {
        originalXpState: any;
        newXpState: any;
...
declare class NexusEventWindow extends NexusDungeonBaseWindow {
    ...
    setupContent(header: any, text: any, options: any, centerText: any, artifactHighlights: any, keywordHighlights: any, objectHighlights: any): void;
...
declare class NexusMapController {
    ...
    get exitButtonDesription(): "If you exit doing an enemy encounter, the encounter will be reset" | null;
    ...
    displayFinalResult({ xpDistribution, avatarXpInfo, runeMods }: {
        xpDistribution: any;
        avatarXpInfo: any;
        runeMods: any;
    }, text: any): void;
...
declare class NexusMapPlayerVoteIcon {
    constructor({ name, icon: { emoteId, avatarInfo: { avatar: { avatarName, outfitName, colorName, optionName, optionActive, animatedHeadColorName }, }, }, }: {
        name: any;
        icon: {
            emoteId: any;
            avatarInfo: {
...
declare class NexusArtifactOptionBase extends NexusOptionBase {
    constructor({ name, fileName, description }: {
        ...
        fileName: any;
        description: any;
    }, avatarDescriptions: any, rewardPreview: any, maxThree: any);
...
declare class NexusArtifactRewardOption extends NexusArtifactOptionBase {
    constructor({ name, fileName, description }: {
        ...
        fileName: any;
        description: any;
    }, avatarDescriptions: any, rewardWindow: any, soloReward: any, rewardPreview: any, maxThree: any);
    rewardWindow: any;
    soloReward: any;
}
declare class NexusArtifactRewardAvatarTarget {
    constructor({ avatarName, outfitName, optionName, optionActive, colorName, animatedHeadColorName, animated }: {
        avatarName: any;
        outfitName: any;
        optionName: any;
        optionActive: any;
...
declare class NexusMapTile {
    constructor(staticCtx: any, dynamicCtx: any, extraDynamicCtx: any, $iconOverlayContainer: any, row: any, column: any, tileInnerWidth: any, incomingConDirections: any, outgoingConDirections: any, genre: any, typeId: any);
    row: any;
    column: any;
    tileInnerWidth: any;
...
declare class NexusDungeonNextFloorWindow extends NexusDungeonBaseWindow {
    ...
    displayContent(nextFloor: any, fragments: any, avatars: any, artifactLocks: any): void;
    reset(): void;
...
declare class NexusDungeonNextFloorAvatar {
    constructor({ avatarName, outfitName, optionName, optionActive, colorName, sizeModifier, animated }: {
        ...
        sizeModifier: any;
        animated: any;
    }, backgroundVert: any, maxHealth: any, currentHealth: any, artifacts: any, artifactLock: any);
    $body: JQuery<HTMLElement>;
    $imageContainer: JQuery<HTMLElement>;
...
declare class NexusStoreArtifact extends NexusArtifactOptionBase {
    constructor({ name, fileName, description, shopId, price, brought, avatarName }: {
        name: any;
        fileName: any;
        description: any;
        shopId: any;
...
declare class NexusStoreRuneMod extends NexusOptionBase {
    constructor({ name, fileName, description, shopId, price, brought }: {
        name: any;
        fileName: any;
        description: any;
        shopId: any;
...
declare class NexusAbilityPopover extends NexusBasePopover {
    constructor();
    displayAbility({ name, description, fileName, cooldownLength, currentCooldown }: {
        name: any;
        description: any;
        fileName: any;
        cooldownLength: any;
        currentCooldown: any;
    }, $triggerElement: any, handlerId: any, forcedDirection: any): void;
}
declare var nexusAbilityPopover: NexusAbilityPopover;
declare class NexusArtifactPopover extends NexusBasePopover {
    constructor();
    displayArtifact({ name, description, fileName }: {
        name: any;
        description: any;
        fileName: any;
    }, $triggerElement: any, handlerId: any): void;
}
...
declare class NexusAvatarPopover extends NexusBasePopover {
    ...
    activeBadge: boolean;
    displayAvatar({ name, baseStats, runeInfo, genreInfo, abilityInfo, badgeInfo }: {
        name: any;
        baseStats: any;
        runeInfo: any;
        genreInfo: any;
        abilityInfo: any;
        badgeInfo: any;
    }, avatarInfo: any, $triggerElement: any, handlerId: any): void;
}
declare var nexusAvatarPopover: NexusAvatarPopover;
declare class NexusBadgePopover extends NexusBasePopover {
    constructor();
    displayBadge(badgeInfo: any, $triggerElement: any, handlerId: any, direction: any): void;
}
...
declare class NexusBasePopover {
    ...
    displayDefault(typeName: any, name: any, description: any, src: any, srcSet: any, $triggerElement: any, handlerId: any, forceDirection: any, $image: any, jsonSrc: any, atlasSrc: any, optionActive: any): void;
    setupContent(typeName: any, name: any, description: any, src: any, srcSet: any, triggerLoad?: boolean, $image?: null, jsonSrc?: null, atlasSrc?: null, optionActive?: null): void;
...
declare class NexusBuffPopover extends NexusBasePopover {
    constructor();
    displayBuff({ name, description, fileName, debuff }: {
        name: any;
        description: any;
        fileName: any;
        debuff: any;
...
declare class NexusRunePopover extends NexusBasePopover {
    constructor();
    displayRune({ name, description, fileName, amount, inUseAmount, type }: {
        name: any;
        description: any;
        fileName: any;
        amount: any;
...
declare class NexusTutorialController {
    ...
    startRuneSetupTutorial($runeContainer: any, $slotContainer: any, $minorRuneContainer: any, $minorRuneContainerTwo: any, $sharedRuneSlot: any, $slotCounter: any, $saveButton: any, $clearButton: any, $runePageContainer: any): void;
    NEXUS_TUTORIAL_IDS: {
...
declare class BaseNexusTutorial {
    ...
    addEvent(text: any, element: any, centerPosition: any, triggerHandler: any, delay: any, centerOffsetX: any, centerOffsetY: any): void;
...
declare class NexusTutorialBasePositionElement {
    constructor(element: any, vertPosition: any, horPosition: any, noOffsetbackdrop: any, backdropOffsetX: any, backdropOffsetY: any, extraOffsetX: any, extraOffsetY: any);
    element: any;
    vertPosition: any;
    horPosition: any;
...
declare class NexusTutorialDungeonLobby extends BaseNexusTutorial {
    constructor(tutorialId: any, $slot: any, $settingRow: any, $rating: any, $floor: any);
}
...
declare class NexusCityTutorialCityPositionElement extends NexusTutorialBasePositionElement {
    constructor(staticElement: any, vertPosition: any, horPosition: any, noOffsetbackdrop: any, backdropOffsetX: any, backdropOffsetY: any);
    get elementCords(): {
        xCord: any;
        yCord: any;
    };
...
declare class NexusTutorialRuneSetup extends BaseNexusTutorial {
    constructor(tutorialId: any, $runeContainer: any, $slotContainer: any, $minorRuneContainer: any, $minorRuneContainerTwo: any, $sharedRuneSlot: any, $slotCounter: any, $saveButton: any, $clearButton: any, $runePageContainer: any);
}
...
declare class NexusTutorialDungeonCombat extends BaseNexusTutorial {
    constructor(tutorialId: any, $enemyContainer: any, $turnOrder: any, $partyContainer: any);
}
declare class NexusTutorialDungeonRewards extends BaseNexusTutorial {
    constructor(tutorialId: any, $fragments: any, $artifactRow: any, $runeRow: any, $continueButton: any);
}
...
declare class Patreon {
    ...
    backerLevel: number;
    delinked: boolean;
    setup(patreonId: any, backerLevel: any, badgeLevel: any, usersCustomEmojis: any, patreonBadgeInfo: any, desynced: any): void;
    _patreonChangeListner: Listener | undefined;
    _desyncListener: Listener | undefined;
    _emojiTab: EmojiPreviewTab | undefined;
    updateModalContent(patreonId: any, backerLevel: any, badgeLevel: any, currentBadge: any, nextBadge: any, usersCustomEmojis: any, desynced: any): void;
    unlinkPatreon(): void;
...
declare class PlayerProfile {
    ...
    createContextMenuObject(playerName: any, offline: any, inGame: any): {
        selector: string;
        trigger: string;
...
declare class PlayerProfileController {
    ...
    loadProfileIfClosed(profileName: any, $requestObject: any, offsetCorrections: any, closeHandler: any, offline: any, inGame: any): void;
    loadProfile(profileName: any, $requestObject: any, offsetCorrections: any, closeHandler: any, offline: any, inGame: any): void;
    clearProfiles(): void;
    toogleEdit(): void;
    calculateOffset($requestObject: any, offsetCorrections: any): {
        x: any;
        y: any;
    };
...
declare class ProfileImageSelector {
    constructor($profile: any, avatarImage: any, emoteImageId: any, avatarInfo: any, profile: any);
    $avatarButton: any;
    $emoteContainer: any;
    $profileImage: any;
...
declare function RoomTile(settings: any, host: any, hostAvatar: any, id: any, numberOfPlayers: any, numberOfSpectators: any, players: any, inLobby: any, parent: any, songLeft: any, tutorialRoom: any, $scrollContainer: any): void;
declare class RoomTile {
    constructor(settings: any, host: any, hostAvatar: any, id: any, numberOfPlayers: any, numberOfSpectators: any, players: any, inLobby: any, parent: any, songLeft: any, tutorialRoom: any, $scrollContainer: any);
    settings: any;
    id: any;
    host: any;
    _inLobby: any;
    ...
    togglePrivate(): void;
    isPrivate(): any;
    translateSongSelection(songSelection: any): "Random" | "Mainly Watched" | "Only Watched" | "Custom" | undefined;
...
declare class Options {
    ...
    show(): void;
    setup(malName: any, malLastUpdate: any, settings: any, aniListName: any, aniListLastUpdate: any, kitsuName: any, kitsuLastUpdate: any, useRomajiNames: any, serverStatuses: any, hostNames: any): void;
    autoSubmit: any;
    showListNumber: any;
...
declare class AvatarDisplayHandler {
    ...
    displayAvatarAnimated(jsonSrc: any, atlasSrc: any, buildOnCreate: any, lazyLoadInfo: any, onloadCallback: any, optionActive: boolean | undefined, startPoseId: any, delayPoseChange: any): void;
...
declare class LazyLoadHandler {
    constructor($content: any, $lazyLoadContainer: any, strictLazy: any, $lazyOffsetParent: any, horiLasyLoad: any, delayLasyLoad: any, lasyLoadOffsetMod?: number, callback?: () => void);
    $content: any;
...
declare class PopoutMessages {
    ...
    displayRankedRewardMessage(position: any, oldScore: any, oldRank: any, newScore: any, newRank: any, oldBadge: any, newBadge: any): void;
...
declare class PreloadImage {
    constructor($img: any, src: any, srcset: any, triggerLoad?: boolean, defaultSizes?: null, onloadCallback?: null, noPreload?: boolean, $lazyLoadContainer?: null, strictLazy?: boolean, $lazyOffsetParent?: null, horiLasyLoad?: boolean, delayLasyLoad?: boolean, lasyLoadOffsetMod?: number);
    $img: any;
    src: any;
    srcset: any;
    defaultSizes: any;
...
declare function displayMessage(title: any, msg: any, callback?: () => void, outsideDismiss?: boolean, disableSWAL?: boolean, confirmButtonText?: undefined): any;
declare function displayHtmlMessage(title: any, html: any, buttonText: any, callback: any): any;
declare function displayOption(title: any, msg: any, acceptMsg: any, declineMsg: any, callback: any, callbackCancel: any, outsideDismiss?: boolean): any;
...
declare function createHoverablePopoverHandlers($parent: any, playerName: any): {
    onMouseEnter: () => void;
    onMouseLeave: () => void;
    onClick: () => void;
};
...
declare function convertTypeInfoToText(type: any, typeNumber: any): string | undefined;
declare function convertSecondsToTimeString(totalSeconds: any): string;
declare function convertListStatusIdToName(statusId: any): "Completed" | "Watching" | "On Hold" | "Dropped" | "Planning" | "Looted" | undefined;
...
declare class TextCounter {
    constructor($textContainer: any, speedMs: any, tickCallback: any, defaultValue?: number, finishedCallback?: null);
    $textContainer: any;
...
declare class SongHistoryGameEntry {
    constructor({ quizId, startTime, roomName, settingString }: {
        quizId: any;
        startTime: any;
        roomName: any;
        settingString: any;
    }, songLoad?: boolean, displayOnSong?: boolean);
    quizId: any;
    startTime: any;
    roomName: any;
    songLoad: boolean;
...
declare class SongHistoryOptionTab extends SongHistoryTab {
    constructor($tab: any, tabSwitchHandler: any, $tableContainer: any, $noSongMessage: any, $optionContainer: any, columnChangeHandler: any, nameTargetChangeHandler: any, listTargetChangeHandler: any);
    $showNamesSlider: any;
    $animeListSlider: any;
...
declare class StoreResonanceSystem {
    ...
    setupTarget({ avatarId, colorId, badges, badgeIds }: {
        avatarId: any;
        colorId: any;
        badges: any;
        badgeIds: any;
    ...
    displayResonanceState({ resonancePoints, resonanceTarget }: {
        resonancePoints: any;
        resonanceTarget: any;
    }): void;
...
declare class StoreTicketHistoryEntry {
    constructor({ type, description, tier, rhythm }: {
        type: any;
        description: any;
        tier: any;
        rhythm: any;
...
declare class StoreTicketRollSelector {
    constructor($ticketOptionContainer: any, historyHandler: any, rollTargets: any, ticketPromoAvatar: any);
    $mainContainer: JQuery<HTMLElement>;
...
declare class StoreTickets {
    constructor(mainContainer: any, recentTicketRewards: any, rollTargets: any, saleInfo: any, ticketPromoAvatar: any);
...
declare class StoreTile {
    constructor(imgSrc: any, imgSrcset: any, backgroundSrc: any, name: any, tag: any, notePrice: any, realMoneyPrice: any, colorTicketTier: any, avatarTicketTier: any, patreonTierToUnlock: any, defaultImageSize: any, extraClasses?: any[], uniqueUnlock?: boolean, eventColor?: boolean, animated?: boolean, jsonSrc?: null, atlasSrc?: null);
    colorTicketTier: any;
    onloadCallbacks: any[];
    ...
    setupContent(imgSrc: any, imgSrcset: any, backgroundSrc: any, defaultImageSize: any): void;
...
declare class StoreTopBar {
    constructor($parentWindow: any, designs: any, unlockedDesigns: any, mainContainer: any, emoteGroups: any, unlockedEmoteIds: any, favoriteAvatars: any, recentTicketRewards: any, rollTargets: any, saleInfo: any, ticketPromoAvatar: any);
...
declare class StoreWindow {
    ...
    setup(defaultDesigns: any, unlockedDesigns: any, currentAvatar: any, characterUnlockCount: any, avatarUnlockCount: any, emoteGroups: any, rhythm: any, unlockedEmoteIds: any, favoriteAvatars: any, recentTicketRewards: any, avatarTokens: any, rollTargets: any, saleInfo: any, resonanceState: any, ticketPromoAvatar: any): void;
...
declare function showForgotPasswordRecoveryMessage(message: any, alert: any): void;
